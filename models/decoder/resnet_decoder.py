...
class ResnetDepthDecoder(nn.Module):
    ...
    def __init__(self, cfg, num_ch_enc, use_skips=True):
        ...
        # Both UniDepth and Depth Anything (V1 and V2) provide the first/base
        # depth layer; this decoder only predicts positive offsets for the
        # remaining layers.
        has_external_base_depth = cfg.model.name in {"unidepth", "depth_anything_v1", "depth_anything_v2"}
